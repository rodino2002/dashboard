    ...
    return (
        <main className="flex h-sreen w-full">
            ...
            <div className=" h-screen grid place-items-center w-full ">
                ...
                <form className="text-zinc-700 w-[35%]">
                    ...
                    <button type="submit" className="p-2 rounded-lg bg-sky-800 text-white w-full text-center mt-10 hover:bg-sky-900 duration-300 cursor-pointer">Sign in</button>
                    ...
                    <div className="flex space-x-6 justify-between items-center">
                        <button className="flex space-x-2 items-center mt-4 rounded-lg ring-1 ring-zinc-200 p-2 w-full justify-center cursor-pointer">
                        ...
                        <button className="flex space-x-2 rounded-lg mt-4 items-center ring-1 ring-zinc-200 p-2 w-full justify-center cursor-pointer">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 48 48">
